...
const FeaturedBenefits = dynamic(() =>
    import('../components/sections/FeaturedBenefits').then((mod) => mod.FeaturedBenefits)
)

// import { FeaturedBenefits } from '../components/sections/FeaturedBenefits'
const FeaturedPartners = dynamic(() => import('../components/sections/FeaturedPartners/FeaturedPartners').then((mod) => mod.FeaturedPartners))
const GlobalFooter = dynamic(() => import('../components/sections/GlobalFooter').then((mod) => mod.GlobalFooter))
const GlobalNavigation = dynamic(() => import('../components/sections/GlobalNavigation').then((mod) => mod.GlobalNavigation))
